...
*Update 9/30/17: Code for a faster version of Groupby is available [here](https://github.com/esantorella/hdfe/blob/master/hdfe/groupby.py)
as part of the [hdfe](https://github.com/esantorella/hdfe) package.
